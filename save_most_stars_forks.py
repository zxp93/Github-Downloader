...
def get_api_repos(api):
    ...
    repos_dict = json.loads(r.content.decode())
...
def get_all_repos(languages):
    ...
    page = '9'
    repo_stars_api = 'https://api.github.com/search/repositories?q=stars:>10000&sort=stars&per_page=100&page={}&access_token={}'.format(page,
        access_token)
    repo_forks_api = 'https://api.github.com/search/repositories?q=forks:>10000&sort=forks&per_page=100&page={}&access_token={}'.format(page,
        access_token)
